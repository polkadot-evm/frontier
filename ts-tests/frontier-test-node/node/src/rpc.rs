...
use frontier_test_runtime::{Hash, AccountId, Index, opaque::Block, Balance, UncheckedExtrinsic};
...
pub struct FullDeps<C, P, SC> {
	...
	pub command_sink: futures::channel::mpsc::Sender<sc_consensus_manual_seal::rpc::EngineCommand<Hash>>,
}
	...
	SC: SelectChain<Block> +'static,
{
	...
	io.extend_with(
		EthApiServer::to_delegate(EthApi::new(
			...
			select_chain,
			pool.clone(),
			frontier_test_runtime::TransactionConverter,
			is_authority,
		))
	);
