...
use {
	...
	pallet_evmless::GasWeightMapping,
};
	...
	Runtime: pallet_evmless::Config,
{
	...
	pub fn db_write_gas_cost() -> u64 {
		<Runtime as pallet_evmless::Config>::GasWeightMapping::weight_to_gas(
